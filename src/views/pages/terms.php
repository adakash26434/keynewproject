<div class="max-w-2xl">
  <div class="card p-8 space-y-6">
    ...
    <?php
    $sections = [
      ['title'=>'Acceptance of Terms','body'=>'By using Personal Key Wallet, you agree to these terms. If you do not agree, please do not use the application.'],
      ['title'=>'Description of Service','body'=>'Personal Key Wallet is a secure, self-hosted digital vault for storing passwords, documents, finance records, and tasks. The service is provided as-is.'],
      ...
      ['title'=>'Limitation of Liability','body'=>'The developers of Personal Key Wallet shall not be liable for any data loss, security breach, or damages arising from the use of this application, to the maximum extent permitted by applicable law.'],
