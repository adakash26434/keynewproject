...
<div class="space-y-6">
  ...
  <div class="card p-6">
    ...
    $tips = [
      ...
      ['title'=>'Password Best Practices','color'=>'bg-purple-100 text-purple-700','tips'=>['Use a unique password for every service.','Strong password = 12+ chars, mixed case, numbers, symbols.','Use Aakash Key Vault\'s built-in password generator.','Change passwords immediately if you suspect a breach.']],
